...
const Navbar = () => {
    ...
    const fetchSublinks = async() =>{
        ...
        try{
            ...
            console.log("sublinks data:", res.data.data);;
        }
        catch(error){
  ...
  return (
    <div className={` bg-richblack-900 flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 `}
    >
        <div className="flex w-11/12 max-w-maxContent items-center justify-between">
            <Link to="/">
                <img src={logo} alt="logo" width={240} height={50} loading="lazy" />
            </Link>
